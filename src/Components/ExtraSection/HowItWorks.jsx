    ...
    return (
      <div className='py-10 bg-no-repeat bg-cover ' style={{backgroundImage:`url(${bgHowItWorks})`}}>
         <div className='flex flex-col gap-4   mx-auto lg:px-20 '>
          <div className='text-center  md:px-15 lg:px-20 space-y-2 py-4 mx-auto'>
          ...
          <div className='grid grid-cols-1 lg:px-0   md:grid-cols-2 lg:grid-cols-3 space-y-4  relative lg:gap-6  lg:py-10 my-25 '>
