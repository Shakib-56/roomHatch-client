        ...
        fetch(`http://localhost:3000/roommates/${_id}`,{
           ...
           headers:{
            ...
            if(data.modifiedCount){
                ...
                position: "center",
                icon: "success",
                title: "Rommate Data updated successfully",
...
<p className="text-lg text-center text-gray-700 mb-8">
  Fill out the form below to list your space and find the right match.
            ...
            <form  onSubmit={handleUpdateRoommate} className='border bg-red-200 border-red-500 px-5 py-6 rounded' >
                <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
        <fieldset className="fieldset p-2">
        <label className="label text-xl">Title</label>
        <input type="text" className="input w-full border " name='title' defaultValue={title} placeholder= {`(e.g., "Looking for a roommate in NYC"`} />
        </fieldset>
        <fieldset className="fieldset  p-2">
        <label className="label  text-xl">Location</label>
        <input type="text" className="input w-full border" name='location' defaultValue={location} placeholder="Enter your location"  required />
        </fieldset>
        <fieldset className="fieldset p-2">
        <label className="label text-xl">Rent Amount</label>
        <input type="number" className="input border w-full" defaultValue={rent} name='rent'  />
        </fieldset>
        <fieldset className="fieldset  p-2">
        ...
        <input type="text" className="input w-full border" name='lifestyle' defaultValue={lifestyle} placeholder="Lifestyle Preferences (Pets, Smoking, etc.)" />
        </fieldset>
       
        <fieldset className="fieldset  p-2">
        <label className="label text-xl">Contact Info </label>
        <input type="text" className="input w-full border" name='contact'defaultValue={contact}   required  />
        </fieldset>
        <fieldset className="fieldset  p-2">
...
export default UpdateRommateDetails;