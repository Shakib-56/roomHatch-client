...
const HowItWorks = () => {
      ...
      <div className='md:py-4 lg:py-10  bg-no-repeat bg-cover ' style={{backgroundImage:`url(${bgHowItWorks})`}}>
         <div className='flex flex-col gap-4   mx-auto lg:px-20 '>
          <div className='text-center  md:px-15 lg:px-20 lg:space-y-2 lg:py-4 mx-auto'>
           ...
           {/* <div className='grid grid-cols-1 md:grid-cols-2  lg:grid-cols-3 gap-4  lg:gap-2 px-4 md:px-10 lg:px-0 lg:py-10 my-15 '>
            <Slide direction="left" cscade damping={0.2} triggerOnce>
              <div className="card bg-base-100 max-w-md mx-auto  shadow-xl hover:bg-red-200 ">
  ...
  <div className="card-body items-center text-center">
   ...
   <Slide direction="up" cscade damping={0.2} triggerOnce>
      <div className="card bg-base-100 max-w-md mx-auto shadow-xl hover:bg-red-200  lg:absolute lg:left-20   lg:top-32">
  <figure className="px-10 pt-10">
    <img
      src={image_2}
      alt="Shoes"
...
<div className="card bg-base-100 max-w-md mx-auto  shadow-xl hover:bg-red-200  lg:absolute lg:bottom-10 lg:right-1">
  <figure className="px-10 pt-10">
    <img
      src={image_3}
      alt="Shoes"
  ...
  <div className="card-body items-center text-center">
    <h2 className="card-title">Pick your Rommate and Enjoy</h2>
           ...
           <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 px-4 md:px-10 lg:px-0 py-20'>
  ...
  <Slide direction="up" cascade damping={0.2} triggerOnce>
    <div className="card bg-base-100 w-full max-w-md mx-auto shadow-xl hover:bg-red-200 lg:absolute lg:top-32 transition-all duration-300">
      <figure className="px-10 pt-10">
        <img
          src={image_2}
          alt="image_howIt_works-1"
